...
#  1) sololearn module 1 quiz ის ჩათვლით - დიდად სოლოლერნზე არგვიმუშავია ამიტომ თუ ვერ მიხვდებით ასე რა არის ეს რაზმის ლიდერს მიმართეთ და დაგეხმარებათ
...
# ნებისმიერი კითხვის შემთხვევაში თუ რაიმე იქნება გაუგებარი შეგიძლიათ მიმართოთ თქვენს ლიდერს ან მეც  
